...
<body>
	<div class="panel panel-default">
		<div class="panel-heading">
			<div class="text-muted bootstrap-admin-box-title">链接编辑</div>
		</div>
		<div class="panel-body">
			<form class="form-horizontal" action="${ctxModule}/${action}" method="post">
				...
				<div class="form-group">
					<label class="col-md-2 control-label">href：</label>
					<div class="col-md-6">
						<input name="href" maxlength="50" class="form-control required"
							value="${entity.href}" />
					</div>
				</div>
				<div class="form-group">
