...
<script src="${ctx}/static/script/LodopFuncs.js" type="text/javascript"></script>
<!-- 
...
<font face="宋体">&nbsp;通常情况下,在页面中嵌入Lodop的如下引用代码，然后用一个全局对象变量来使用控件：</font></td>       
  ...
  <tr>  
    <td width="100%" height="22"><font face="宋体">·</font>页面不添加以上引用代码也行，getLodop过程会动态建立它们，语句简化如下：</font></td>
  </tr>
  <tr>  
    <td width="100%" height="20"><span LANG="ZH"><font color="#0000FF" size="2" face="宋体">&nbsp;&nbsp;&nbsp;      
